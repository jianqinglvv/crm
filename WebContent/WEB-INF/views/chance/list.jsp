...
<div style="text-align:right; padding:6px 6px 0 0;">
	...
	&nbsp;&nbsp;
	<a href="${ctp }/chance/list?pageNo=1&${params}">首页</a>
	<c:if test="${!page.hasPrev }">
		上一页
	</c:if>
	<c:if test="${page.hasPrev }">
		<a href="${ctp }/chance/list?pageNo=${page.prev}&${params}">上一页</a>
	</c:if>
...
<script type="text/javascript">
	...
	<form action="" method="post" id="hiddenForm">
		<input type="hidden" name="_method" value="delete" id="hiddenMethod">
	</form>
